...
$(call inherit-product-if-exists, vendor/lge/e405/e405-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/lge/e405/overlay
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/init.e1.rc:root/init.e1.rc \
    $(LOCAL_PATH)/ueventd.e1.rc:root/ueventd.e1.rc \
    $(LOCAL_PATH)/init.e1.usb.rc:root/init.e1.usb.rc
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/prebuilt/init.qcom.sh:/init.qcom.sh \
#    $(LOCAL_PATH)/prebuilt/DualSimStatus.apk:system/app/DualSimStatus.apk
# Wifi
PRODUCT_COPY_FILES += \
