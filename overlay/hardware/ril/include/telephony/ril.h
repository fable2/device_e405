...
/* SMS SIM number variable parsed betweem ril.cpp and reference-ril */
static int DSDS_SMS_SIM;
static int DSDS_SMS;
...
/**
 * RIL_REQUEST_CHANGE_ACTIVE_SIM
 *
 * Request to set the Active SIM as provided
 * by the user
 *
 * "data" is sim number to be set
 *
 * "response" is NULL
 */
#define RIL_REQUEST_ACKNOWLEDGE_INCOMING_GSM_SMS_WITH_PDU 106
#define RIL_REQUEST_CHANGE_ACTIVE_SIM 108

/**
 * RIL_REQUEST_RADIO_POWER_SIM_TWO
 *
 * To differentiate the radio power state between the sim one and sim two
 * 
 */
#define RIL_REQUEST_STK_SEND_ENVELOPE_WITH_STATUS 107
#define RIL_REQUEST_RADIO_POWER_SIM_TWO 109
...
/**
 * Return string for SIM number
 */
typedef int (*RIL_DSDS) (void);	
